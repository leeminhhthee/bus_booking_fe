...
const SeatSelectionScreen = () => {
  ...
  const [selectedSeats, setSelecteSeats] = useState<number[]>([])
  ...
  const handleOnPay = () => {
    if (selectedSeats.length === 0) {
      Alert.alert('Please select at least one seats.')
      return
    }
